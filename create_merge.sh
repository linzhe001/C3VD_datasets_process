...
# 直接在脚本中设置参数
POSE_ROOT="./C3VD"               # pose数据集根目录：每个场景文件夹下包含 pose.txt
PLY_ROOT="./C3VD_ply"            # ply数据集根目录：每个场景文件夹下包含 fragments_ply
NEW_DATASET_ROOT="./fused_C3VD_new"  # 新数据集保存目录，用于 partial 模式输出
